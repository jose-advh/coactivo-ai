...
export default function UserRegister() {
  ...
  return (
    <section className="w-[100%] h-[100dvh] bg-[url('/login-background.jpg')] flex justify-around items-center m-auto">
      <div className="w-[90%] sm:w-[70%] h-[70%] rounded-xl flex items-center m-auto shadow-xl">
        {/* Lado izquierdo */}
        <article className="hidden sm:flex flex-col rounded-xl items-center justify-center backdrop-blur-2xl bg-[#9a5820] h-[100%] w-[50%]">
          <Image
            src="/login_man.svg"
            width={250}
            height={250}
        ...
        {/* Formulario */}
        <form
          className="w-[100%] md:w-[50%] h-[100%] flex flex-col rounded-xl py-5 backdrop-blur-3xl items-center justify-center gap-5"
